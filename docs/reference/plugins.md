...
[GUIDE.md](guide.md), [API_POLICY.md](../explanation/api-policy.md), and
[LLM_REFERENCE.md](llm-reference.md) rather than re-reading the same
content twice.
...
[README](https://github.com/qubitrenegade/clickwork/blob/main/README.md#plugin-discovery) for the precedence rules.
...
[API_POLICY.md](../explanation/api-policy.md#protocol-level-surfaces) for the exact
promise.
...
[LLM_REFERENCE.md's common footguns](llm-reference.md#common-footguns).
...
- **Importing private clickwork modules.** Anything under
  ...
  documented in [API_POLICY.md](../explanation/api-policy.md#public-api-surface).
