...
[API_POLICY.md](../explanation/api-policy.md); the full change ledger lives in
[CHANGELOG.md](https://github.com/qubitrenegade/clickwork/blob/main/CHANGELOG.md).
...
[LLM_REFERENCE.md](llm-reference.md) footgun #3.
...
[LLM_REFERENCE.md](llm-reference.md) as footgun #1.
...
bug. See [API_POLICY.md](../explanation/api-policy.md#click-version-range) for the
full rationale.
...
[API_POLICY.md](../explanation/api-policy.md#deprecation-policy) for the runway
...
- [CHANGELOG.md](https://github.com/qubitrenegade/clickwork/blob/main/CHANGELOG.md) -- full per-release change ledger.
- [API_POLICY.md](../explanation/api-policy.md) -- the post-1.0 compatibility promise,
  Click and Python version-range policy, deprecation runway length.
- [LLM_REFERENCE.md](llm-reference.md) "Common Footguns" section --
