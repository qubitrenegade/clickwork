...
breakages are catalogued in [`MIGRATING.md`](../reference/migrating.md).

Related docs: [`MIGRATING.md`](../reference/migrating.md) for the 0.x to 1.0
upgrade path (covers every breaking change introduced in 1.0),
and [`SECURITY.md`](../reference/security.md) for the security properties
...
- The layered config precedence order (environment variables, then
  ...
  [`GUIDE.md#config-precedence`](../reference/guide.md#config-precedence) for the
